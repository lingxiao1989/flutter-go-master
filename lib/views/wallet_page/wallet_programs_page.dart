...
import 'package:flutter_go/components/list_view_program_item.dart';
...
class ProgramPage extends StatefulWidget {
  @override
  ProgramPageState createState() => new ProgramPageState();
}

class ProgramPageState extends State<ProgramPage> with AutomaticKeepAliveClientMixin{
  ...
  Widget makeCard(index,item){
    ...
    return new ListViewProgramItem(itemPic: backPic,itemUrl: codeUrl,itemTitle: myCardName,data: myProgramName,);
  }
  _showSettingSheet() {
